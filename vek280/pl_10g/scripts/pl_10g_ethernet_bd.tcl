...
################################################################
# This is a generated script based on design: pl_10g_ethernet
#
...
# source pl_10g_ethernet_script.tcl
...
set design_name pl_10g_ethernet
...
{PMC_MIO 26 .. 36}}} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base_0/TX3_GT_IP_Interface pl_10g_ethernet_xxv_ethernet_0_1_0./xxv_ethernet_0/gt_tx_serdes_interface_0.0 /gt_quad_base_0/RX3_GT_IP_Interface pl_10g_ethernet_xxv_ethernet_0_1_0./xxv_ethernet_0/gt_rx_serdes_interface_0.0}\
\
    CONFIG.GT_TYPE {GTYP} \
...
DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE TX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base_0 {/gt_quad_base_0 undef,undef,undef,pl_10g_ethernet_xxv_ethernet_0_1_0.IP_CH0 MSTRCLK 0,0,0,1 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base_0\
{/gt_quad_base_0 undef,undef,undef,pl_10g_ethernet_xxv_ethernet_0_1_0.IP_CH0 MSTRCLK 0,0,0,1 IS_CURRENT_QUAD 1}}} \
  ...
  connect_bd_net -net bufg_gt_0_rxoutclk_usrclk [get_bd_pins bufg_gt_0_rxoutclk/usrclk] [get_bd_pins xxv_ethernet_0/rx_core_clk_0] [get_bd_pins xxv_ethernet_0/rx_serdes_clk_0] [get_bd_pins axi_noc_0/aclk7] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins proc_sys_reset_rx/slowest_sync_clk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins gt_quad_base_0/ch3_rxusrclk]
  ...
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins clk_wizard_0/clk_out1] [get_bd_pins versal_cips_0/m_axi_fpd_aclk] [get_bd_pins axi_noc_0/aclk6] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins xxv_ethernet_0/s_axi_aclk_0] [get_bd_pins proc_sys_reset_axi/slowest_sync_clk] [get_bd_pins smartconnect_0/aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_axi/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins xxv_ethernet_0/s_axi_aresetn_0]
